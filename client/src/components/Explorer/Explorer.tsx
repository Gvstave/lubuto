...
export default function Explorer({ tree, onSelect, activeLanguageId, activeLessonNumber }: Props) {
  ...
  return (
    <div className="h-full overflow-auto text-black py-4 border-r border-gray-300">
      {tree.map((language) => {
